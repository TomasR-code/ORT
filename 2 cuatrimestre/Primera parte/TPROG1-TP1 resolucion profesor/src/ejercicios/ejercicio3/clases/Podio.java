...
public class Podio {
	...
	// Generics.
	// Hay dos opciones: una es crear un vector de Objects.
	// La otra es esta
	private MasRapidos[] posiciones;

	public Podio() {
		posiciones = new MasRapidos[CANT_POSICIONES];
